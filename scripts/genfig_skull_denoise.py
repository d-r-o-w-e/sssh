...
def render_skull(V, F, outpath, numpy_scalar, cmapname, vminmax=None):
    ...
    meshpos = (0.42, 0.01, 0.72) # UI: click mesh > Transform > Location
    meshrot = (68, 0, 67) # UI: click mesh > Transform > Rotation
    meshscale = (0.8, 0.8, 0.8) # UI: click mesh > Transform > Scale
...
# file locations
outpng_gt = "../results/pngs/skull_fndenoise_gt.png"
outpng_noisy = "../results/pngs/skull_fndenoise_noisy.png"
outpng_lapl2 = "../results/pngs/skull_fndenoise_lapl2.png"
outpng_steinetal2018 = "../results/pngs/skull_fndenoise_steinetal2018.png"
outpng_ours = "../results/pngs/skull_fndenoise_ours.png"
outnpy = "../results/npys/skull_fndenoise.npy"
...
modelfilename = "../models/skull_low_resolution.obj"
...
if regen_np:
    orig_fn = heat_ridge_alpha(V, F, np.array([0]), 0.5)
    
    u0 = orig_fn + 0.04*rng.uniform(-1, 1, size=V.shape[0])
    alpha_ours = 44.675350189208984
    alpha_lapl2 = 0.11566162109375
    alpha_stein = 78.5
...
render_skull(V, F, outpng_gt, orig_fn, cmaps[0], vminmax=vmm)
render_skull(V, F, outpng_noisy, u0, cmaps[0], vminmax=vmm)
render_skull(V, F, outpng_lapl2, lapl2_fn, cmaps[1], vminmax=vmm)
render_skull(V, F, outpng_steinetal2018, steinetal2018_fn, cmaps[2], vminmax=vmm)
render_skull(V, F, outpng_ours, recovered_fn, cmaps[3], vminmax=vmm)