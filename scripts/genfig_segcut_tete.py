...
def render_seg(Vis, Fis, adjs, outpath):
    ...
    meshpos = (0.51, 0, 0.92) # cube
    meshrot = (90, 0, 492) # cube
    meshscale = (1.0, 1.0, 1.0) # cube
...
filename_obj = "../results/objs/segmentation_cut_" + meshname + ".obj"
...
eps2 = 0.001 # ending epsilon in A-T formula
